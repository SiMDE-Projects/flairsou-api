    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "associated_entity",
                    models.UUIDField(
                        default=None, null=True, verbose_name="associated_entity"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "use_equity",
                    models.BooleanField(
                        default=False, verbose_name="Use Equity Accounts"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "invoice",
                    models.FileField(
                        null=True, upload_to="uploads/", verbose_name="Invoice"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "label",
                    models.CharField(
                        max_length=128, null=True, verbose_name="Operation label"
                    ),
                ),
                (
                    "account",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("entity",), name="flairsou_api_book_one_book_per_entity"
            ),
        ),
        migrations.AddField(
            model_name="account",
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="flairsou_api.book"
            ),
        ),
        migrations.AddField(
            model_name="account",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("account", "date"),
                name="flairsou_api_reconciliation_one_reconc_per_date",
            ),
        ),
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                ...
                name="flairsou_api_operation_unique_account_transaction",
            ),
        ),
        migrations.AddConstraint(
            model_name="operation",
            constraint=models.CheckConstraint(
                ...
                name="flairsou_api_operation_debit_xor_credit",
            ),
        ),
        migrations.AddConstraint(
            model_name="entity",
            constraint=models.UniqueConstraint(
                fields=("name",), name="flairsou_api_entity_unique_name"
            ),
        ),
        migrations.AddConstraint(
            model_name="entity",
            constraint=models.CheckConstraint(
                check=models.Q(_negated=True, name=""),
                name="flairsou_api_entity_name_not_null",
            ),
        ),
        migrations.AddConstraint(
            model_name="account",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(_negated=True, name=""),
                name="flairsou_api_account_name_not_null",
            ),
        ),
    ]
