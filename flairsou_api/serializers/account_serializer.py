...
class AccountSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        # si la requête est POST, on fait les tests pour la création d'un nouveau compte, on
        # va donc vérifier des contraintes d'existence en bdd qui ne doivent pas être vérifiées
        ...
        if create:
            # ces points doivent être vérifiés uniquement à la création et pas à la mise à jour
