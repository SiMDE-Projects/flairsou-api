...
class TransactionAPITestCase(APITestCase):
    ...
    def test_create_transaction(self):
        ...
        op2 = {"credit": 0, "debit": 100, "label": "Expense 1", "account": self.bank.pk}
        ...
        self.assertEqual(
            response.data["operations"][1]["account"][0],
    ...
    def test_transaction_same_account(self):
        ...
        op2 = {"credit": 0, "debit": 50, "label": "Expense 1", "account": self.bank.pk}

        op3 = {"credit": 0, "debit": 50, "label": "Expense 1", "account": self.bank.pk}
    ...
    def test_transaction_same_book(self):
        ...
        op2 = {"credit": 0, "debit": 100, "label": "Expense 1", "account": account2.pk}
